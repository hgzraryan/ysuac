<?php
$q_sitemasters_degree="SELECT {$_BLANG} FROM {$CONF['dbtable']['masters_degree']}";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	<tr>
		<td colspan="3" height="29" align="center" valign="center">
			...
			<div id="departments_link2">&nbsp;{$_SL['masters_degree']}</div>
		</td>
	</tr>
	<tr><td colspan="3" height="20"></td></tr>
	<tr>
		<td height="20">
			<div id="departments_fhl"></div><div id="departments_title">{$_SL['masters_degree']}</div>
		</td>
	</tr>
	<tr><td height="20"></td></tr>
	<tr>
		<td valign="top" id="bologna_text">
			{$row_sitemasters_degree[$_BLANG]}
		</td>
	</tr>
