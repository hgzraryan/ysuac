<?php
$q_siteentry_course="SELECT {$_BLANG} FROM {$CONF['dbtable']['entry_course']}";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	<tr>
		<td colspan="3" height="29" align="center" valign="center">
			...
			<div id="departments_link2">&nbsp;{$_SL['entry_course']}</div>
		</td>
	</tr>
	<tr><td colspan="3" height="20"></td></tr>
	<tr>
		<td height="20">
			<div id="departments_fhl"></div><div id="departments_title">{$_SL['entry_course']}</div>
		</td>
	</tr>
	<tr><td height="20"></td></tr>
	<tr>
		<td valign="top" id="bologna_text">
			{$row_siteentry_course[$_BLANG]}
		</td>
	</tr>
