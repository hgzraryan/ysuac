...
$q_catd_wall="SELECT * FROM {$CONF['dbtable']['slideshow']} LIMIT {$p_pageing}, {$j_pageing}";
...
echo <<<html
					...
					<tr>
						...
						<td id="wallpaper_row" valign="center" width="120" >
							<a href="../images/slider/{$row_catd_wall['path']}" class="highslide" onclick="return hs.expand(this)">
								<img src="../images/slider/min_thumbs/{$row_catd_wall['path']}" border="0" width="80">
							</a>
...
html;
							if($row_catd_wall['status']=="1"){
echo <<<html
								<input type="submit" class="gallery_switch_e" name="slideshow_switch" value="{$row_catd_wall['id']}" title="{$LANG['admin_news3'][$_SESSION['lang']]}">
html;
							}else{
echo <<<html
								<input type="submit" class="gallery_switch_d" name="slideshow_switch" value="{$row_catd_wall['id']}" title="{$LANG['admin_news2'][$_SESSION['lang']]}">
html;
							}
echo <<<html
						</td>
...
echo <<<html
	...
	<tr>
		<td colspan="3" valign="top" align="right" height="30">
			<a href="#" onclick="return hs.htmlExpand(this, { headingText: '{$LANG['admin_wall13'][$_SESSION['lang']]}' })" id="cat_wall">
				<img src='images/add.png' name='wall_add'>
			</a>
				<input type='image' src='images/delete.png' height='21' border='0' name='slideshow_delete'>
			</form>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
						<tr>
							<td height="130" align="center" valign="top">
								  <div class="button">{$LANG['admin_cat4'][$_SESSION['lang']]}<input type="file" name="slideshow_img" /></div>
							</td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td height="18" align="center">
								<input type="text" id="cat_wall_textarea" name="slideshow_amt" value="{$LANG['admin_lang2'][$_SESSION['lang']]}" onfocus="this.value=(this.value==&quot;{$LANG['admin_lang2'][$_SESSION['lang']]}&quot;) ? &quot;&quot; : this.value;" onblur="this.value=(this.value==&quot;&quot;) ? &quot;{$LANG['admin_lang2'][$_SESSION['lang']]}&quot; : this.value;">
							</td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td height="18" align="center">
								<input type="text" id="cat_wall_textarea" name="slideshow_rut" value="{$LANG['admin_lang3'][$_SESSION['lang']]}" onfocus="this.value=(this.value==&quot;{$LANG['admin_lang3'][$_SESSION['lang']]}&quot;) ? &quot;&quot; : this.value;" onblur="this.value=(this.value==&quot;&quot;) ? &quot;{$LANG['admin_lang3'][$_SESSION['lang']]}&quot; : this.value;">
							</td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td height="18" align="center">
								<input type="text" id="cat_wall_textarea" name="slideshow_ent" value="{$LANG['admin_lang4'][$_SESSION['lang']]}" onfocus="this.value=(this.value==&quot;{$LANG['admin_lang4'][$_SESSION['lang']]}&quot;) ? &quot;&quot; : this.value;" onblur="this.value=(this.value==&quot;&quot;) ? &quot;{$LANG['admin_lang4'][$_SESSION['lang']]}&quot; : this.value;">
							</td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td height="18" align="center">
								<input type="text" id="cat_wall_textarea" name="slideshow_frt" value="{$LANG['admin_lang5'][$_SESSION['lang']]}" onfocus="this.value=(this.value==&quot;{$LANG['admin_lang5'][$_SESSION['lang']]}&quot;) ? &quot;&quot; : this.value;" onblur="this.value=(this.value==&quot;&quot;) ? &quot;{$LANG['admin_lang5'][$_SESSION['lang']]}&quot; : this.value;">
							</td>
						</tr>
						<tr><td height="10"></td></tr>
						<tr>
							<td align="right" valign="center" height="33">
								<input type="image" id="departments_add_buttons" src="images/add_buttons_{$_SESSION['lang']}.png" name="add_slideshow" value="add" title="{$LANG['admin_wall0'][$_SESSION['lang']]}" onMouseOver=this.src="images/add_buttonsa_{$_SESSION['lang']}.png" onMouseOut=this.src="images/add_buttons_{$_SESSION['lang']}.png">
							</td>
						</tr>
						<tr><td></td></tr>
					</table>
