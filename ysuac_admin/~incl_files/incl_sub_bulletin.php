...
$q_bulletin="SELECT * FROM {$CONF['dbtable']['bulletin']} ORDER BY id DESC";
...
html;
				...
				while( ($row_bulletin=mysql_fetch_assoc($r_bulletin))!=false){
					if($row_bulletin['size']>=1024 && $row_bulletin['size']<=1048576){
						$size_d=($row_bulletin['size']/1024);
						$size_n=explode(".",$size_d);
						$size_r=substr($size_n[1], 0, 2);
						$size="{$size_n[0]}.{$size_r} {$LANG['admin_wall6'][$_SESSION['lang']]}";
					}elseif($row_bulletin['size']>=1048576){
						$size_d=($row_bulletin['size']/1024/1024);
						$size_n=explode(".",$size_d);
						$size_r=substr($size_n[1], 0, 2);
...
echo <<<html
					...
					<tr>
						...
						<td id="wallpaper_row" valign="center" width="120" >
							<a href="../images/library/bulletin/origin/{$row_bulletin['thumbnails']}" class="highslide" onclick="return hs.expand(this)">
								<img src="../images/library/bulletin/thumbs/{$row_bulletin['thumbnails']}" border="0" width="80">
							</a>
						</td>
						<td id="wallpaper_row" valign="center" width="285">
							<div title="{$title_lang}" id="wallpaper_row_text">
								{$row_bulletin['real_name']}
							</div>
						</td>
	...
	<tr>
		<td colspan="3" valign="top" align="right" height="30">
			<a href="#" onclick="return hs.htmlExpand(this, { headingText: '{$LANG['admin_wall14'][$_SESSION['lang']]}' })" id="cat_wall">
				...
				<input type='image' src='images/delete.png' height='21' border='0' name='bulletin_delete'>
			</form>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
						<tr>
							<td height="130" align="center" valign="top" colspan="2">
								  <div class="button">{$LANG['admin_cat4'][$_SESSION['lang']]}<input type="file" name="bulletin_thumb" /></div>
							</td>
						</tr>
						...
						<tr>
							...
							<td height="18" align="left">
								<input type="text" name="bulletin_name" id="bulletin_input">						
							</td>
						</tr>
						<tr><td height="10" colspan="2"></td></tr>
						<tr>
							...
							<td height="18" align="left">
								<input type="file" name="bulletin_file" id="bulletin_input">						
							</td>
						</tr>
						<tr><td height="10" colspan="2"></td></tr>
						<tr>
							...
							<td height="18" align="left">
								<select name="bulletin_number" id="bulletin_selection">
...
echo <<<html
						...
						<tr>
							...
							<td height="18" align="left">
								<select name="bulletin_year" id="bulletin_selection">
									<option value="0"></option>
html;
...
echo <<<html
						...
						<tr>
							...
							<td height="18" align="left">
								<input type="text" name="bulletin_pages" id="bulletin_pages">					
							</td>
						</tr>
						<tr><td height="10" colspan="2"></td></tr>
						<tr>
							<td align="right" valign="center" height="33" colspan="2">
								<input type="image" id="departments_add_buttons" src="images/add_buttons_{$_SESSION['lang']}.png" name="add_bulletin" value="add" title="{$LANG['admin_wall14'][$_SESSION['lang']]}" onMouseOver=this.src="images/add_buttonsa_{$_SESSION['lang']}.png" onMouseOut=this.src="images/add_buttons_{$_SESSION['lang']}.png">
							</td>
						</tr>
